...
import { FaFacebookSquare, FaLinkedin,FaWhatsapp,FaInstagram } from "react-icons/fa";
...
export default function Footer() {
  return (
    <footer className="bg-slate-300 relative left-0 right-0 bottom-0 shadow-md ">
      <div className="grid  grid-cols-8 gap-2 mx-10 p-10">
        {/* logo */}
          ...
          <div className="grid grid-cols-3 items-center">
            ...
            <div className="col-span-2">
              <h2 className="text-justify">
               ...
               is an authorized employment agency,
...
personnel for all categories of foreign employment.
        ...
        <div className="col-span-2">
          ...
          <div className="flex flex-col mt-2 text-start items-center justify-start">
          ...
          <div className="gird grid-row-2 ">
            <div className="grid grid-rows-2 grid-flow-col gap-1">
              <div className="flex flex-row gap-3 items-center mb-2">
                ...
                <div>
                <p>No.250D/2, Pannipitiya Road,Thalawathugoda, </p><p>Sri Lanka.</p>
                </div>
            ...
            <div className=" mt-[-40px] flex  ">
                <Link to="https://www.facebook.com/LBNKEYRESOURCEPVTLTD?mibextid=ZbWKwL " target="_blank">
