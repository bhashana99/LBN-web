...
export default function Vacancies() {
  ...
  return (
    <div className=" max-w-4xl  mx-auto w-full my-10">
      <div>
        <h1 className="text-3xl font-bold text-rose-700 underline mb-5">
          Vacancies
        </h1>
      </div>
      <div>
        {showVacancy && showVacancy.length > 0 && (
          <div className="">
            {showVacancy.map((vacancy) => (
              <div
                key={vacancy._id}
                className="flex flex-col md:flex-row  gap-5 border-solid border-2 border-slate-200 mb-4 shadow-2xl md:shadow-lg hover:shadow-2xl mx-5 md:mx-0"
              >
                ...
                <div className="flex flex-col gap-3 basis-2/4 ml-3 md:ml-0">
                  ...
                  <div className="mt-2">
                    <p className="text-green-800 font-bold">{vacancy.salary}</p>
                  </div>
                </div>
